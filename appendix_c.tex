...
\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{log }\OtherTok{\textless{}{-}}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{rescale}\NormalTok{(}\FunctionTok{log}\NormalTok{(df\_scores}\SpecialCharTok{$}\NormalTok{scl), }\AttributeTok{to =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}
    \DecValTok{1}\NormalTok{))}
\CommentTok{\# Square root transform}
\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{sqrt }\OtherTok{\textless{}{-}}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{rescale}\NormalTok{(}\FunctionTok{sqrt}\NormalTok{(df\_scores}\SpecialCharTok{$}\NormalTok{scl), }\AttributeTok{to =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}
    \DecValTok{1}\NormalTok{))}
\CommentTok{\# Cube root transform}
\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{qrt }\OtherTok{\textless{}{-}}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{rescale}\NormalTok{(df\_scores}\SpecialCharTok{$}\NormalTok{scl}\SpecialCharTok{\^{}}\FloatTok{0.33}\NormalTok{, }\AttributeTok{to =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}
    \DecValTok{1}\NormalTok{))}
\CommentTok{\# Reciprocal transform}
\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{reciprocal }\OtherTok{\textless{}{-}}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{rescale}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{scl, }\AttributeTok{to =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}
    \DecValTok{1}\NormalTok{))}
...
\NormalTok{df\_scores}\SpecialCharTok{$}\NormalTok{boxcox }\OtherTok{\textless{}{-}}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{rescale}\NormalTok{(df\_scores}\SpecialCharTok{$}\NormalTok{boxcox, }\AttributeTok{to =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}
    \DecValTok{1}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res\_final }\OtherTok{\textless{}{-}} \FunctionTok{mx\_switch\_labels}\NormalTok{(res\_step[[}\DecValTok{3}\NormalTok{]], }\AttributeTok{param =} \StringTok{"M[1,7]"}\NormalTok{,}
...
\NormalTok{tab\_res }\OtherTok{\textless{}{-}}\NormalTok{ tab\_res[tab\_res}\SpecialCharTok{$}\NormalTok{Category }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Means"}\NormalTok{, }\StringTok{"Variances"}\NormalTok{),}
    \FunctionTok{c}\NormalTok{(}\StringTok{"Category"}\NormalTok{, }\StringTok{"lhs"}\NormalTok{, }\StringTok{"est"}\NormalTok{, }\StringTok{"se"}\NormalTok{, }\StringTok{"pval"}\NormalTok{, }\StringTok{"confint"}\NormalTok{, }\StringTok{"name"}\NormalTok{)]}
\NormalTok{tab\_res}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wald\_tests }\OtherTok{\textless{}{-}} \FunctionTok{wald\_test}\NormalTok{(res\_final, }\StringTok{"}
