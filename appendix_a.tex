...
\NormalTok{aux\_model }\OtherTok{\textless{}{-}} \FunctionTok{BCH}\NormalTok{(res\_final, }\AttributeTok{model =} \StringTok{"freqvisit \textasciitilde{} distance"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df\_aux)}
\end{Highlighting}
\end{Shaded}
