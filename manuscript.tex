...
\hypersetup{
  ...
  pdfauthor={Caspar J. van Lissa1,2 \& Mauricio Garnier-Villarreal3},
  pdflang={en-EN},
...
on a parametric model. Its examples include mixture models, latent class
analysis (with continuous and/or ordinal indicators), and latent class (mixture)
...
\leavevmode\vadjust pre{\hypertarget{ref-enders_applied_2010}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hardy_exploring_2018}{}}%
