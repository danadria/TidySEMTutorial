...
\hypersetup{
  ...
  pdfauthor={Caspar J. van Lissa1,2, Mauricio Garnier-Villarreal3, \& Daniel Anadria1},
  pdflang={en-EN},
...
models in the \texttt{tidySEM} R-package whose backend relies on \texttt{OpenMx}.
}
...
\item
  ...
  \end{itemize}
\item
  Justify the (preregistered) criteria used to eliminate models from
...
\item
  ...
  \tightlist
  \item
    If entropy \textgreater{} .95 and posterior classification probability for
    each class \textgreater{} .95, this is less crucial
  \end{itemize}
\end{enumerate}
...
\leavevmode\vadjust pre{\hypertarget{ref-depmixS4}{}}%
