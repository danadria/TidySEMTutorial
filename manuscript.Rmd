...
SHould not be used to select a particural class solution i fclass separability is too low
if the group is too small to be meaningful or to calculate descriptive statistics
could be used to disqualify certain solutions
