...
Models can be specified in `tidySEM` in different ways.
...
which indicate the relative support the data provides for each model in the set [@wagenmakers_aic_2004].
...
Specific models can be compared using the function `BLRT()`.
