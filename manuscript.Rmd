...
Latent class analysis has become quite popular across scientific fields,
and under a number of different names.
...
Despite the popularity of the method, there is a noted absence of 
guidelines for estimating and reporting latent class analyses [].
...
and that alternative 
	...
	* See Nylund
1. Starting values [@nylund-gibsonTenFrequentlyAsked2018; ]
