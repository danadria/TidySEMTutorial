...
for example, Mplus [@muthen_mplus_1998], for which the R-package `MplusAutomation` offers augmented LCA functionality [@hallquist_mplusautomation_2018], and LatentGOLD [REF].
...
information without imputing missing values [@enders_relative_2001].
...
Other authors have reported similar experiences [@sinha_practitioners_2021].
